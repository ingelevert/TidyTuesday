...
def analyze_rainfall_effect_improved(df):
    ...
    ax = sns.boxplot(
        ...
        palette=["#5154a4", "#56a8cb", "#5dc863", "#cae931"], 
        width=0.6,
        showfliers=True,  
    ...
    plt.tight_layout()
    plt.savefig("2025/Week_20_Water_Quality_Sydney/Graphs/enterococci_by_rain.png", dpi=300)
    plt.close()
